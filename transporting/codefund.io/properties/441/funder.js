(function () {
  ...
  if (!document.getElementById(codefundStylesheetId)) {
    ...
    stylesheet.setAttribute('href', 'https://codefund.io/packs/css/code_fund_ad-fa201a47.css')
  ...
  if (document.getElementById(codefundScriptId)) {
    ...
    script.setAttribute('src', 'https://codefund.io/packs/js/code_fund_ad-b031f68753717b6433bc.js')
